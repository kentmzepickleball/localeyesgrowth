...
// Source: React Bits — Components/OptionWheel (TS + Tailwind variant)
// https://reactbits.dev/components/option-wheel
// Adapted for this project: added "use client" (App Router requires it for
// any component using hooks) — layout/logic otherwise unchanged.
const OptionWheel = ({
  items = DEFAULT_ITEMS,
  defaultSelected = 3,
  onChange,
