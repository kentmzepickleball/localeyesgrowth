...
type: hub
pillar: P2
title: The Mobile Caterer's Lead-to-Booking Playbook
slug: mobile-caterer-lead-to-booking-playbook
date: "2026-09-15"
author: "Kent Sheridan"
category: "Leads and Booking"
seo_title: "The Mobile Caterer's Lead-to-Booking Playbook: How to Get Catering Clients"
meta_description: Most caterers need about 5 inquiries per booking and should close 15 to 30% of quotes. Here is the full funnel, from lead source to repeat client.
primary_keyword: how to get catering clients
secondary_keywords: catering lead generation, how to book more catering events, mobile catering sales process
source_docs: lead-generation.md, sales-and-closing.md, operations-and-systems.md, client-experience-and-retention.md, proof-bank.md, Flashquotes coffee cart catering cost study (CC BY 4.0)
stat_value: "5"
stat_label: "inquiries needed for every booking"
conversion_target: Growth Diagnostic
status: draft
---

# The Mobile Caterer's Lead-to-Booking Playbook
...
1. Being findable on Google, because buyers compare whoever shows up.
2. Responding in minutes, not hours.
3. Following up until you get an explicit yes or no.
4. Qualifying before you quote.
5. Selling the experience and holding your price.
6. Building venue and vendor relationships that feed you work without ad spend.
...
1. Walk them through the DIY alternative in concrete detail. Sourcing, staffing, inventory, line management, drinks not up to standard. Your project management becomes visible.
2. Hold the price and offer a payment plan.
3. Subtract scope to hit their budget. Remove an hour, a signature drink, a premium tier. Never add more to justify the number.
4. Graciously help them find someone cheaper. Deliberate word choice, and it keeps your position intact.
...
To find out exactly where your funnel leaks, run the [Growth Diagnostic](/growth-diagnostic). We check your rankings, Google Business Profile, site conversion path, and response process, then walk you through the findings live. No pitch deck, just the list of what is costing you bookings.
